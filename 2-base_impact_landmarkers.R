...
detailed_ir <- readRDS("results/landmarkers_detailed_results_ir.rds")
detailed_rp <- readRDS("results/landmarkers_detailed_results_rp.rds")
...
strategies <- c("original","pairwise", "ranking",  "ratio")
...
levels(results_all_normalized$strategy)[levels(results_all_normalized$strategy)=="original"] <- "AB"
levels(results_all_normalized$strategy)[levels(results_all_normalized$strategy)=="pairwise"] <- "PW"
levels(results_all_normalized$strategy)[levels(results_all_normalized$strategy)=="ranking"] <- "RK"
levels(results_all_normalized$strategy)[levels(results_all_normalized$strategy)=="ratio"] <- "RT"
