...
metadatasets=c("RM.csv","SL_RP.csv","GR.csv","CM_RP.csv")
metrics=c("rmse","nmae")
i <- 0
j <- 1
...
saveRDS(complete_results,"results/new_results_meta_rp.rds")
saveRDS(detailed_results, "results/new_detailed_results_rp.rds")
...
complete_results <- readRDS("results/new_results_meta_rp.rds")

i <- 1
new_metrics <- c("Accuracy_rmse","Accuracy_nmae")
metrics <- c("RMSE","NMAE")
metadatasets=c("RM","SL","GR","CM")
...
complete_results <- readRDS("new_results_meta_ir.rds")
i <- 1
